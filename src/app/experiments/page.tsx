  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-blue-50 to-green-50 p-8">
      ...
      <section className="py-40 px-4 bg-white">
        <div className="container mx-auto text-center">
          <div className="flex items-center justify-center mb-6">
            ...
            <h1 className="mx-6 text-6xl font-extrabold text-blue-800">
              ...
              <div className="md:w-1/2 p-8 flex items-center">
                <div>
                  ...
                  <p className="text-lg text-gray-800">
                    書類を1ページ丸ごと読み取るため、従来のOCR製品では必須だったテンプレート登録が不要。
                    必要なのは欲しい情報の指定だけ。
                  </p>
                </div>
              </div>
          ...
          <ul className="space-y-6 max-w-3xl mx-auto">
            <li className="flex items-start">
              ...
              <div className="ml-4">
                ...
                <p className="text-lg text-gray-800">
                  紙や画像で送られてくる帳票を手入力で処理していませんか？ScanMateならPDFをアップロードするだけで必要な情報を自動的にCSV化します。
                </p>
              </div>
            </li>
            <li className="flex items-start">
              ...
              <div className="ml-4">
                ...
                <p className="text-lg text-gray-800">
                  少人数のバックオフィス業務では帳票処理が大きな負担。ScanMateを導入すれば、面倒な作業から解放され、本来の業務に専念できます。
                </p>
              </div>
            </li>
            <li className="flex items-start">
              ...
              <div className="ml-4">
                ...
                <p className="text-lg text-gray-800">
                  手書き・PDF・FAXなど形式がバラバラな書類から必要項目を探すのは大変です。ScanMateは印字も手書きも正確に抽出し、転記作業を大幅に削減します。
                </p>
              </div>
            </li>
          </ul>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center">
            ...
            <div className="flex flex-col items-center bg-gray-50 border border-gray-200 rounded-lg p-6 w-64 h-80 mt-8 md:mt-0">
              ...
              <h3 className="text-xl font-semibold text-gray-800">【任意】プロンプト設定</h3>
              <p className="text-lg text-gray-600 text-center mt-2">
                必要に応じて、追加の指示を入力します。
              </p>
            </div>
        ...
        <div className="flex items-center justify-center mb-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card>
              <CardContent className="p-6 text-center">
                <div className="bg-gray-100 h-24 rounded mb-4"></div>
                <h3 className="text-lg font-semibold">手書き文字 (鉛筆・カラーペンにも対応)</h3>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-6 text-center">
          ...
          <div className="text-center mb-8">
            <p className="text-lg text-gray-800">その他の機能</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card>
              <CardContent className="p-6 text-center">
      ...
      <section className="py-16 bg-blue-800 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-4">まずは無料トライアルから</h2>
          <p className="text-2xl mb-8">お気軽にお試しください</p>
          <div className="flex gap-4 justify-center">
